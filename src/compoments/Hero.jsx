    ...
    return (
        <div className="relative h-dvh w-screen overflow-x-hidden">
            ...
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75">
                ...
                {/* silksong img */}
                <h1 className="special-font hero-heading absolute bottom-5 right-5 z-40 text-blue-75 hidden">Gaming</h1>
                <img src="img/silksong-white.png" alt="solksong-white" className="absolute bottom-5 right-5 z-40 w-56 lg:w-80 md:w-72 sm:w-60"/>

                <div className="absolute left-0 top-0 z-40 size-full">
                    <div className="mt-24 px-5 sm:px-10">
                        <h1 className="hero-heading text-blue-100 ">Hollow Knight:</h1>
            ...
            {/* silksong black */}
            <h1 className="special-font hero-heading absolute bottom-5 right-5 text-black hidden">Gaming</h1>
            <img src="img/silksong-black.png" alt="solksong-black" className="absolute bottom-5 right-5 w-56 lg:w-80 md:w-72 sm:w-60"/>
        </div>
    )
}
